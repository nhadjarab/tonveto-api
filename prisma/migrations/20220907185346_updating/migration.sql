/*
  ...
  - You are about to alter the column `identification_order` on the `Vet` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
...
CREATE TABLE "new_Vet" (
    ...
    "identification_order" BIGINT NOT NULL DEFAULT 1111111111,
